...
from .views import ProductListCreateAPIView,MyProductListAPIView,ProductRetrieveUpdateDestroyAPIView,NearbyProductListAPIView,PrductListCreateAPIView

urlpatterns = [
    path('products/', ProductListCreateAPIView.as_view(), name='product-list-create'),
    path('product/', PrductListCreateAPIView.as_view(), name='product-list-create'),
